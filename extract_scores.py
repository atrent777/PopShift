        ...
        with sdf.open() as f:
            ...
            for line in f:
                if search_re.match(line):
                    ...
                    next_line = False
                    break
    #kd_list_out = np.array(kd_list, dtype='f4')
    #print(f'kdList:\n{kdListOut}')
    return np.array(out_list, dtype='f4'), np.array(kd_list, dtype='f4')
        ...
        with sdf.open() as f:
            ...
            for line in f:
                if search_re.match(line):
                    ...
                    out_list.append(float(line))
                    next_line = False
                    break
    return np.array(out_list, dtype='f4')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rescore_gnina', action=ap.BooleanOptionalAction, default=False,
    ...
    if args.rescore_gnina : args.result_type = 'gnina_rescore'
